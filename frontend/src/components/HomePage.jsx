    ...
    >
      ...
      <motion.div 
        ...
        className="flex-1 text-center md:text-center mt-20 md:mt-0">
          ...
          <button class="group relative inline-flex h-14 mt-6 items-center justify-center overflow-hidden rounded-md bg-emerald-400 hover:bg-cyan-300 px-6 font-medium text-black duration-500">
            <div class="translate-x-0 opacity-100 transition group-hover:-translate-x-[150%] group-hover:opacity-0">Download Now!</div>
            <div class="absolute translate-x-[150%] opacity-0 transition group-hover:translate-x-0 group-hover:opacity-100"><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" 
