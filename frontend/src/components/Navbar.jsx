      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex flex-1 justify-center items-center space-x-8 lg:space-x-12 text-lg lg:text-2xl">
            ...
            <a href="#about" className="hover:text-red-600 font-bold duration-300">Features</a>
            <a href="#skills" className="hover:text-red-600 font-bold duration-300">About</a>
            <a href="#exp" className="hover:text-red-600 font-bold duration-300">Contact</a>
          </div>
      ...
      {navOpen && (
        <motion.div
          ...
          <div className="flex flex-col items-center py-4 space-y-4">
            ...
            <a href="#about" onClick={toggleNav} className="hover:text-red-600 font-bold duration-300">Features</a>
            <a href="#skills" onClick={toggleNav} className="hover:text-red-600 font-bold duration-300">About</a>
            <a href="#exp" onClick={toggleNav} className="hover:text-red-600 font-bold duration-300">Contact</a>
          </div>
        </motion.div>
      )}
    </div>
